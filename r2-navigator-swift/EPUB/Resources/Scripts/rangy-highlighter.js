...
(function(factory, root) {
    ...
    rangy.createModule("Highlighter", ["ClassApplier"], function(api, module) {
        ...
        Highlight.prototype = {
            ...
            apply: function(color, border, blockId) {
                this.classApplier.applyToRange(this.getRange(), null, color, border, blockId);
                this.applied = true;
            },
        ...
        Highlighter.prototype = {
            ...
            highlightCharacterRanges: function(className, charRanges, options, color, border, blockId) {
                var i, len, j;
                var highlights = this.highlights;
                ...
                forEach(highlights, function(highlight) {
                    if (!highlight.applied) {
                        highlight.apply(color, border, blockId);
            ...
            highlightRanges: function(className, ranges, options, color, border, blockId) {
                var selCharRanges = [];
                var converter = this.converter;
                ...
                },  color, border, blockId);
            },

            highlightSelection: function(className, options, color, border, blockId) {
                var converter = this.converter;
            ...
            deserialize: function(serialized, color, border, blockId) {
