...
(function(factory, root) {
    ...
    rangy.createModule("Serializer", ["WrappedSelection"], function(api, module) {
        ...
        function restoreSelectionFromString(sel_str) {
            var serialized = sel_str;
            if (serialized) {
                deserializeSelection(serialized, window.doc);
            }
        }
        ...
        util.extend(api, {
            ...
            restoreSelectionFromString: restoreSelectionFromString,
